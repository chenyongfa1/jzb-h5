      ...
      <div class="content">
        ...
        <div class="calculationresults mg16">
          <div class="calculationresultstop">
            ...
            <div class="moneycount">¥ {{count1}}</div>
          </div>
          <div class="calculationresultsbot">
            <div class="enterprise">
              <div class="enterprisecon">企业</div>
              <div class="enterprisecount">¥ {{count2}}</div>
            </div>
            <div class="line"></div>
            <div class="personal">
              <div class="personalcon">个人</div>
              <div class="personalcount">¥{{count3}}</div>
            </div>
          </div>
        </div>
                ...
                <div class="calculaitem calculacity" @click="getCity">
                  <div class="showcity">
                    ...
                    <div class="participantsRight">
                      <span class="addInfo">{{cityNameVal}}</span>
        ...
        <div class="calculacon" v-if="count1 != 0">
          ...
          <div class="detailInfolist ">
            ...
            <div class="detailInfoItem pd16">
              <div class="detailTitle col333">{{fundInfo.level_name}}</div>
              <div class="detailenterprise col333">{{fundInfo.company}}</div>
              <div class="detailpersonal col333">{{fundInfo.personal}}</div>
            </div>
            <div class="detailInfoItem pd16">
              <div class="detailTitle col333">小计</div>
              <div class="detailenterprise col333">{{count2}}</div>
              <div class="detailpersonal col333">{{count3}}</div>
            </div>
            <div class="countsoc pd16">
              <div class="detailTitle">合计：¥ {{count1}}
              </div>
            </div>
          </div>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            showBase() {
                ...
                this.ifBaseSizeMax = this.cityInfo.accumulation_max_money
                this.ifBaseSizeMin = this.cityInfo.accumulation_min_money
            },
            minSocialClick1() {
            ...
            getDetail(){
                ...
                if(this.cityNameVal === ""){
                    ...
                    $.ajax({
                        ...
                        dataType: "JSON",
                        success: function (r) {
                            that.count1 = r.data.total
                            that.count2 = r.data.list.company_subtotal
                            that.count3 = r.data.list.personal_subtotal
                            that.fundInfo = r.data.list[0]
                        }
                    })
                }
