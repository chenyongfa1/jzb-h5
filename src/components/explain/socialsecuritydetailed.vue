        ...
        <div class="mouthdetatil">
          ...
          <div class="deletalist">
            <van-collapse title-class="colF97" v-model="activeName" accordion>
              <van-collapse-item title-class="colF97" title="2019-07" value="基数 2088" name="1">
                <div class="detailInfolist">
                  ...
                  <van-divider />
                  <div class="detailInfoItem">
                    <div class="detailTitle">基本养老保险</div>
                    <div class="detailenterprise">224.40</div>
                    <div class="detailpersonal">427.69</div>
                  </div>
                  <van-divider />
                  <div class="detailInfoItem">
                    <div class="detailTitle">职工社会医疗保险</div>
                    <div class="detailenterprise">224.40</div>
                    <div class="detailpersonal">427.69</div>
                  </div>
                  <van-divider />
                  <div class="detailInfoItem">
                    <div class="detailTitle">失业保险</div>
                    <div class="detailenterprise">224.40</div>
                    <div class="detailpersonal">427.69</div>
                  </div>
                  <van-divider />
                  <div class="detailInfoItem">
                    <div class="detailTitle">工伤保险</div>
                    <div class="detailenterprise">224.40</div>
                    <div class="detailpersonal">427.69</div>
                  </div>
                  <van-divider />
                  <div class="detailInfoItem">
                    <div class="detailTitle">生育保险</div>
                    <div class="detailenterprise">224.40</div>
                    <div class="detailpersonal">427.69</div>
                  </div>
                  <van-divider />
                  <div class="detailInfoItem">
                    <div class="detailTitle">残保金</div>
                    <div class="detailenterprise">224.40</div>
                    <div class="detailpersonal">427.69</div>
                  </div>
                  <van-divider />
              ...
              <van-collapse-item title-class="colF97" title="2019-07" value="价钱" name="2">
                <div class="detailInfolist">
                  <div class="detailInfoItem">
                    <div class="detailTitle col333">险种</div>
                    <div class="detailenterprise col333">企业缴纳(元)</div>
              ...
              <van-collapse-item title-class="colF97" title="2019-07" value="价钱" name="3">
                <div class="detailInfolist">
                  <div class="detailInfoItem">
                    <div class="detailTitle col333">险种</div>
                    <div class="detailenterprise col333">企业缴纳(元)</div>
